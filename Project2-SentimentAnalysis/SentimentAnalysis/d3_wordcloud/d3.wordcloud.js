(function() {
  function wordcloud() {
    ...
    function update() {
      ...
      fontSize = d3.scale[scale]().range([10, 65]);
      if (words.length) {
  ...
  function wordcloud2() {
    ...
    wordcloud2.element = function(x) {
      if (!arguments.length) return element;
      element = x == null ? '#wordcloud2' : x;
      return wordcloud2
    };

    wordcloud2.selector = function(x) {
      if (!arguments.length) return selector;
      element = d3.select(x == null ? selector : x);
      return wordcloud2;
    };

    wordcloud2.transitionDuration = function(x) {
      if (!arguments.length) return transitionDuration;
      transitionDuration = typeof x == 'function' ? x() : x;
      return wordcloud2;
    };

    wordcloud2.scale = function(x) {
      if (!arguments.length) return scale;
      scale = x == null ? 'sqrt' : x;
      return wordcloud2;
    };

    wordcloud2.fill = function(x) {
      if (!arguments.length) return fill;
      fill = x == null ? d3.scale.category20b() : x;
      return wordcloud2;
    };

    wordcloud2.onwordclick = function (func) {
        onwordclick = func;
        return wordcloud2;
    }

    wordcloud2.start = function() {
      init();
      layout.start(arguments);
      return wordcloud2;
    };
    ...
    return d3.rebind(wordcloud2, layout, 'on', 'words', 'size', 'font', 'fontStyle', 'fontWeight', 'spiral', 'padding');
  }

  
  if (typeof module === "object" && module.exports) module.exports = wordcloud;
  else {d3.wordcloud = wordcloud;
  d3.wordcloud2 = wordcloud2;}
})();
